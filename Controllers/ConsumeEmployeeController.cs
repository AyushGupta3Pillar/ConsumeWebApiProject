using ConsumeWebApiProject.Models;
using System;
...
namespace ConsumeWebApiProject.Controllers
{
    public class ConsumeEmployeeController : Controller
    {
        HttpClient client = new HttpClient();
        public ActionResult Index()
        {
            List<Employee> emp_list = new List<Employee>();
            client.BaseAddress = new Uri("https://localhost:44324/api/CrudApi");
